...
const AdminLayout = () => {
  ...
  const navigation = [
    ...
    { name: t('nav.categories'), href: '/admin/categories', icon: FolderIcon },
    { name: t('nav.users'), href: '/admin/users', icon: UsersIcon },
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <h1 className="text-xl font-bold text-gray-900">VnBest Admin</h1>
